...
**A note on our Guide reader**: Our product is designed to help you find, navigate and digest
the Guide content most relevant to you.
And that includes search features.
Try it out—the results include definitions, section-by-section content, and the **hundreds
of resources we’ve linked to** throughout the Guide.
Think of it as a mini library of the best content on equity compensation.
We also provide mouseover (or short tap on mobile) for definitions, related section
suggestions and external links while you read. [Let us know](mailto:hello@holloway.com) if
