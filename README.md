...
- Options expire. You need to know how long the **exercise window** will be open.
  ...
  - Recently (in 2015) a few companies are now finding ways to keep the exercise window open for years after leaving a company, and promote this as fairer to employees. See [this list](https://github.com/holman/extended-exercise-windows), which includes
...
- As of 2015, there are income brackets at **10%**, **15%**, **25%**, **28%**, **33%**, **35%**, and **39.6%** [marginal tax rates](http://www.investopedia.com/terms/m/marginaltaxrate.asp). Be sure you understand how these brackets work, and what bracket you’re likely to be in. 
...
- 🔹 ☝️ Section 83(b) elections cannot be made on the receipt of a stock option. They can only be made on the receipt of actual shares of stock.
...
- Most startups don’t get far. Very roughly, if you [look at angel investments](http://codingvc.com/valuing-employee-options/), **more than 1/2** of investments fail, **1/3** are small successes (1X to 5X returns), **1/8** are big successes (5X to 30x), and **1/20** are huge successes (30X+).
