...
- Stock and stock options may be granted to you, but they come with of conditions and limitations. One of the most significant conditions is **vesting**.
...
- [**Phantom equity**](http://www.investopedia.com/articles/stocks/12/introduction-phantom-stock.asp) (or **phantom stock**) is another type of compensation. It is not especially common, but you may encounter it. It is called “phantom equity” because it is not really equity at all: It is just a contractual promise to make a cash payment, the amount of which is determined by reference to the value of the company’s stock.
...
- Generally, restricted stock is taxed [when it vests](http://www.investopedia.com/articles/tax/09/restricted-stock-tax.asp?performancelayout=true) as ordinary income. Of course, if the stock is in a startup with low value, this may not result in very much tax being owed. But if it iss years later from when the stock was first granted, and the company is worth a lot, the taxes owed could be significant.
- However, the Internal Revenue Code offers an alternative, called a [**Section 83(b) election**](http://acceleratedvesting.com/what-is-an-83b-election-and-when-do-i-make-it-part-1-with-graphic/). A Section 83(b) is an election to be taxed on the receipt of the property that you might not get to keep. It might make sense for the presumption of the tax law to be that you do not owe tax until property you have received vests, but in the private company stock context, electing to be taxed at the time you receive shares that are unvested makes all the sense in the world. If the shares go up in value, the taxes owed on vesting might be a lot greater than the taxes owed at the time of receipt. 
- However, you must file the 83(b) election yourself with the IRS [within 30 days](https://www.irs.gov/irb/2012-28_IRB/ar12.html) of the grant or exercise, or the opportunity is irrevocably lost.
