...
- If you receive an immediately exercisable stock option (meaning, an option that is exercisable despite the fact that it is not vested), you can then make an 83(b) election on your receipt of the shares on exercise, because they are subject to vesting.
- You do not have to make an 83(b) election on shares you receive that are fully vested. Thus, if you receive an option, and you cannot exercise the option until it is vested, you vest, and then you exercise--no 83(b) election is due in that circumstance.
