...
If you’ve ever worked or considered working for a startup or fast-growing tech company,
...
If you’re thinking of working for a company that is offering you equity, it is critical to
...
An understanding of the underlying rules is necessary for negotiating fair offers—on both
sides.

Of course, this Guide can’t replace professional advice.
But talk to anyone who’s worked in startups and they’ll have stories of how they or their
...
This is an **open Guide**. It’s [*open to contributions*](/CONTRIBUTING.md), so, unlike a blog,
...
[Joe Wallin](http://joewallin.com/about-joe-wallin/). It’s a preliminary version, and no doubt
...
- Stock in private companies frequently cannot be sold and may need to be held indefinitely,
  ...
  [usually you can’t buy and sell stock easily](http://www.investopedia.com/ask/answers/06/privatecompanystock.asp).
...
- ☝️🔹 However, there are subtleties to be aware of regarding what this outstanding total
  refers to:
  - Private companies always have what is referred to as **“authorized but unissued”** shares.
  ...
  - You actually want to know the total issued, but even this number can be confusing, as it
    ...
    Typically, people refer to the total number of shares “issued and outstanding” or “fully
    diluted.”
  ...
  - Generally, it’s best to know the fully diluted number to know the likely percentage a
    number of shares is worth in the future.
    The terminology mentioned here isn’t universally applied, either, so it’s worth discussing
...
- It is hard to value private company stock.
  ...
  fate of the company.
- 🔸 Generally, selling stock in a private company may be difficult, as the company is not
...
- 🔹 **Private sales:**
  ...
  of the company (meaning you couldn’t sell your shares to a third party without offering to
  sell it to the company first).
  Another possible roadblock is that private buyers may want the company’s internal
...
- Stock comes in two main types, [**common stock**](https://en.wikipedia.org/wiki/Common_stock) and
  [**preferred stock**](https://en.wikipedia.org/wiki/Preferred_stock). You’ll also hear the term
  ...
  It’s complicated, but in general preferred stock is stock that has rights, preferences,
...
- [**Stock options**](https://en.wikipedia.org/wiki/Employee_stock_option) (called “employee stock
  options” when given to employees) are contracts that allow you to buy shares.
  When you buy shares, it’s called **exercising** the options.
...
- 🔸 **Vesting**: Stock and stock options may be granted to you, but they come with a variety
  of conditions and limitations.
  One of the most significant conditions is that you usually “earn” rights to the shares or
...
- Grants for **advisors** typically vest over a shorter period than employee grants, often two
  ...
  service. Typical terms for advisors, including equity levels, are available from the 📥
  Founder Institute’s [Founder/Advisor Standard Template (FAST)](https://fi.co/contents/fast#).
...
- Generally, restricted stock is taxed
  ...
  tax being owed.
  But if it’s been years since the stock was first granted and the company is now worth a
  lot, the taxes owed could be significant.
- 🔹 However, the Internal Revenue Code offers an alternative, called a
  ...
  With a Section 83(b) election, you’re telling the IRS you want to pay taxes early, on
...
- 🔸 Each stage reflects the removal of risk and increased
...
- 🔹 Information that will help you weigh the offer might be:
  ...
  - *What exit valuation will need to be achieved before common stock is has positive value (What are the liquidation overhangs?)*
...
- If you’re coming from an established company to a startup, you may be asked to take a
  salary cut. This is reasonable, but it’s wise to discuss explicitly how much it is, and
...
- Getting multiple offers is always in your interest.
  ...
  - However, dragging out negotiations excessively so you can “shop around” an offer to other
    companies is considered bad form by some people, so it’s thoughtful to be judicious and
    timely to the extent that it’s possible.
...
This section covers a few kinds of documents you’re likely to see.
