...
In this section we'll lay out the differences, benefits, and drawbacks of common types of granted equity. Both **stock options** and **restricted stock units (RSUs)** are common forms of equity compensation, with RSUs more common for larger companies and options more common for startups.
...
Sounds great, right? But wait just a minute. Let's get into some of those conditions and limiations on your option agreement we mentioned above:
